 ...
 * @author jsdvp
 */
public class FormularioFacultadActualizar extends javax.swing.JDialog {
...
<<<<<<< HEAD
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioFacultadActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormularioFacultadActualizar dialog = new FormularioFacultadActualizar(new javax.swing.JFrame(), true);
