...
public class FormularioPrincipal extends javax.swing.JFrame {
    ...
    private void inicializarPestañas() {
        ...
        jTabbedPane2.addTab("Profesor", new TablaProfesor());
        jTabbedPane2.addTab("Inscripción", new TablaInscripcion());
        jTabbedPane2.addTab("Curso Profesor", new TablaCursoProfesor());
    }
